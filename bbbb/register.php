            ...
            <div class="p-5">
              ...
              <form class="user" method='post' action='php/register.php' >
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="privillege" name='privillege' placeholder="Privillege" required>
                  </div>
                </div>
...
function validatePassword(){
  if (password.value !=confirm_password.value){
    confirm_password.setCustomeValidity("Password don't match");
  }else{
    confirm_password.setCustomeValidity('');
  }
}
